        ...
        <body>
            ...
            <div class='container'>
                ...
                <div class='data humidity'>
                    <div class='side-by-side icon'>
                        <svg enable-background='new 0 0 29.235 40.64'height=40.64px id=Layer_1 version=1.1 viewBox='0 0 29.235 40.64'width=29.235px x=0px xml:space=preserve xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink y=0px><path d='M14.618,0C14.618,0,0,17.95,0,26.022C0,#include <Arduino.h>
                ...
                setInterval(function() 
                {
                    ...
                    xhttp.onreadystatechange = function() 
                    {
                        if (this.readyState == 4 && this.status == 200) 
                        {
                            ...
                            this.responseText.slice(0, 3);
                            document.getElementById("humidity").innerHTML =
                            this.responseText.slice(3, 6);
                            document.getElementById("pressure").innerHTML =
                            this.responseText.slice(6, 9);
